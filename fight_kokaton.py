...
class Beam:
    def __init__(self, bird:"Bird"):
        ...
        kaku = math.atan2(self.vy, self.vx)
        deg = math.degrees(kaku)
        img0 = pg.image.load("fig/beam.png")
        self.img = pg.transform.rotozoom(img0, -deg, 1.0)
...
class explosion:
    ...
    爆発に関するクラス
    """
    def __init__(self, ex:pg.Surface,life: int,center: tuple[int, int]):
        self.imgs =[ex,pg.transform.flip(ex,True,True)]
